...
public class AddBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TFbookTitle.addActionListener(this::TFbookTitleActionPerformed);
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(TFbookGenre, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 37, Short.MAX_VALUE)
                                .addComponent(jLabel6)))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(TFauthor, javax.swing.GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
                            .addComponent(TFcopiesAvailable))
                        .addGap(60, 60, 60))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(TFbookTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
    ...
    private void InsertBttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertBttnActionPerformed
        ...
        try {
            String sql = "INSERT INTO books (Book_Code, Title, Author, Genre, Availability) VALUES (?,?,?,?,?)";
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/lbs_jdbc","root","");
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setString(1, TFbookCode.getText().trim());
            pst.setString(2, TFbookTitle.getText().trim());
            pst.setString(3, TFauthor.getText().trim());
            pst.setString(4, TFbookGenre.getText().trim());
            pst.setInt(5, Integer.parseInt(TFcopiesAvailable.getText()));
            ...
            new AddBook().setVisible(true);
                ...
                JOptionPane.showMessageDialog(null, "Book Code already exists");
        }
